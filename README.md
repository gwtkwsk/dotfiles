...
1. Copy `.chezmoidata.yaml.example` to `.chezmoidata.yaml` and set machine-specific values such as `theme`.
2. Install `chezmoi`.
...
| --- | --- | --- |
| `dotfiles GitHub user` | Fields named `email` and `name` | `dot_gitconfig.tmpl` |
